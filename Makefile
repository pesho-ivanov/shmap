...
CFLAGS = -mavx2 -march=native -lm -lpthread -Igtl/ -Wall -Wextra -Wno-unused-parameter -Wno-unused-result -Wno-comment -fpermissive #-Wconversion 
ifeq ($(DEBUG), 1)
    CFLAGS += $(DEBUG_FLAGS)
else
...
SRCS = src/sweepmap.cpp src/sweepmap.h src/io.h src/sketch.h src/utils.h src/index.h src/embedding.h ext/kseq.h
